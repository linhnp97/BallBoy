...
public interface Level {
    ...
    /**
     * @param entity The entity to be checked.
     * @return boolean True if the provided entity is the squarecat.
     */
    boolean isSquarecat(Entity entity);

    /**
     * return list of entity that have to be deleted.
     */
    List<DynamicEntity> getToDelete ();
    ...
    /**
     * Return number of red enemies killed in this level
     */
    int redScore();

    /**
     * Return number of blue enemies killed in this level
     */
    int blueScore();

    /**
     * Return number of yellow enemies killed in this level
     */
    int yellowScore();
}
